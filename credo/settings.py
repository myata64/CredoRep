...
SECRET_KEY = 'django-insecure-cnz1bjj1c)zrn=c-ol872h7+jjsh+n&l92efd45jw)+!wcf%7r'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'credo/static'),
]

STATIC_URL = "../credo/static/"
